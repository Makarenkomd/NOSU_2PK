...
{   // Тестовый Набор (Test Suite)
    // Все классы в проекте, помеченные атрибутом [TestFixture] означают что данный класс содержит автотесты - тест сьют
    // атрибуты [Test] означают что данные методы это тест кейсы (автотесты)
    ...
    public class ReportMaker_Tests
    {
        ...
        [Test]
        // фильтр юольшого числа устройств
